...
public:
    ...
    using processnoisecovariance = std::function<Eigen::Matrix<scalar_type, process_noise_dof, process_noise_dof>(state &, const input &)>;
    ...
    using measurementModel_dyn_share_modified_cov = std::function<void(state &, Eigen::Matrix3d, Eigen::Matrix3d, dyn_share_modified<scalar_type> &)>;
	using measurementMatrix1 = std::function<Eigen::Matrix<scalar_type, l, n>(state &)>;
	using measurementMatrix1_dyn = std::function<Eigen::Matrix<scalar_type, Eigen::Dynamic, n>(state &)>;
	using measurementMatrix2 = std::function<Eigen::Matrix<scalar_type, l, measurement_noise_dof>(state &)>;
